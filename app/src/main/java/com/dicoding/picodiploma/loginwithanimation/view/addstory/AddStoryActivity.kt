...
class AddStoryActivity : AppCompatActivity() {
    ...
    private fun uploadImage() {
        currentImageUri?.let { uri ->
            ...
            viewModel.addNewStory(token,description, imageFile)
            viewModel.success.observe(this, androidx.lifecycle.Observer { isSuccess ->
                if (isSuccess) {
            ...
            viewModel.error.observe(this, androidx.lifecycle.Observer { error ->
                if (error != null) {
                    showToast(error)
                }
            })
